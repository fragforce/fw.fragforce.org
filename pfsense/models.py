...
class TUPort(models.Model):
    ...
    name = models.CharField(unique=False, null=False, blank=False, help_text="Port common name")
    proto = models.CharField(null=False, default=PROTO_TCP, help_text="IP Protocol", choices=(PROTO_TCP, PROTO_UDP))
    port = models.IntegerField(null=False, default=None, help_text="TCP or UDP port number")


class PortGroup(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    name = models.CharField(unique=True, null=False, blank=False, help_text="Port group name")
...
class FirewallHardwareClass(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    name = models.CharField(unique=True, null=False, blank=False, help_text="Hardware Class Name")
    description = models.TextField(null=False, blank=True, help_text="Extended details")


class FirewallHardware(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    name = models.CharField(unique=True, null=False, blank=False, help_text="Hardware Name")
    description = models.TextField(null=False, blank=True, help_text="Extended details")
...
class Firewall(models.Model):
    ...
    name = models.CharField(unique=True, null=False, blank=False, help_text="Asset Name")
    hostname = models.CharField(unique=True, null=False, blank=False, help_text="Asset hostname")
    description = models.TextField(null=False, blank=True, help_text="Extended details")
    asset_tag = models.CharField(unique=True, null=False, blank=False, help_text="Asset tag")
    org_asset_tag = models.CharField(unique=True, null=False, blank=False,
                                     help_text="Asset id from salesforce org's asset object")


class LogicalFWInterface(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    ifname = models.CharField(unique=False, null=False, blank=False, help_text="Interface name")
